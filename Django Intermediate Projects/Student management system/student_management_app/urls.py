...
urlpatterns = [
    ...
    path('bulk_upload_students_save/', HodViews.bulk_upload_students_save, name="bulk_upload_students_save"),
    path('bulk_upload_students_sample/', HodViews.bulk_upload_students_sample, name="bulk_upload_students_sample"),
    path('bulk_upload_staff/', HodViews.bulk_upload_staff, name="bulk_upload_staff"),
    path('bulk_upload_staff_save/', HodViews.bulk_upload_staff_save, name="bulk_upload_staff_save"),
    path('bulk_upload_staff_sample/', HodViews.bulk_upload_staff_sample, name="bulk_upload_staff_sample"),
